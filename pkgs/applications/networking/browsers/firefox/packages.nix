...
rec {
  firefox = common rec {
    ...
    src = fetchurl {
      ...
      sha512 = "0dmdg4cl55g8jklka0qaqsdr6vqnwigsd831kjxpm33s759j4b4sv90iiqj6vxy81fbl9qrs4l8gx83qc0pw1dxqqkrl0c6cy9hslsx";
    };
  ...
  firefox-esr-68 = common rec {
    ...
    src = fetchurl {
      url = "mirror://mozilla/firefox/releases/${ffversion}/source/firefox-${ffversion}.source.tar.xz";
      sha512 = "2w5ndsnb7767k55md4mcmssddpgylwljxgq4piilsray5x44f9f5x6lxi1pqqrfiizpz6ii5a8i0y11z2fy5vcyxw56hz0gv001hhwq";
    };
